...
import com.easyparty.invitation.templates.showAttendees;
import com.easyparty.invitation.ui.home.EventsActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra("highlight")) {
            if (getIntent().getBooleanExtra("highlight", false)) {
                ((ConstraintLayout) findViewById(R.id.hightlight)).setBackgroundColor(getResources().getColor(R.color.colorPrimaryDark));
